...
/**
 * This class is used to show the submitted form data on request
 */
public class FormOneViewScreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Get the specific form so that we can use it

         */
        /* Peusdo code
        Form form = new Form (String formId);
        form.getDataFields ();
    ...
    private void displaySubmissionData (String formId, String formRecord) {


        Cursor cursor = mDBhelper.getData(formid);            // get data from STUDENT_TABLE and place it in cursor
